...
(function () {
  ...
  const AGES = {
    young: { label: '🐣 幼', desc: '6×6・備妥 15 份', size: 6, kinds: 4, goal: 15, crow: 0 },
    kid: { label: '🙂 童', desc: '7×7・備妥 22 份', size: 7, kinds: 5, goal: 22, crow: 2 },
    teen: { label: '🔥 青', desc: '8×8・備妥 30 份', size: 8, kinds: 6, goal: 30, crow: 3 },
  }
  ...
  class Game {
    ...
    _drawWinCard() {
      ...
      ctx.fillText(`備妥 ${this.cfg.goal} 份——斜的一排也算,憐憫多算一步`, W / 2, H * 0.235)
      ctx.fillStyle = '#3e3418'
